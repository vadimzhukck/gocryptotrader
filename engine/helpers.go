...
func GetSpecificOrderbook(p pair.CurrencyPair, exchangeName string, assetType assets.AssetType) (orderbook.Base, error) {
...
// exchangeName and assetType
func GetSpecificTicker(p pair.CurrencyPair, exchangeName string, assetType assets.AssetType) (ticker.Price, error) {
