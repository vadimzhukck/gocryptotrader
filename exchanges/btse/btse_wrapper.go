...
func (b *BTSE) FetchTicker(p pair.CurrencyPair, assetType string) (ticker.Price, error) {
...
func (b *BTSE) FetchOrderbook(p pair.CurrencyPair, assetType string) (orderbook.Base, error) {
