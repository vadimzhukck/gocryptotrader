...
func (b *BTSE) UpdateTicker(p pair.CurrencyPair, assetType assets.AssetType) (ticker.Price, error) {
	var tickerPrice ticker.Price

	t, err := b.GetTicker(b.FormatExchangeCurrency(p, assets.AssetTypeSpot).String())
	if err != nil {
...
func (b *BTSE) FetchTicker(p pair.CurrencyPair, assetType assets.AssetType) (ticker.Price, error) {
...
func (b *BTSE) FetchOrderbook(p pair.CurrencyPair, assetType assets.AssetType) (orderbook.Base, error) {
...
func (b *BTSE) UpdateOrderbook(p pair.CurrencyPair, assetType assets.AssetType) (orderbook.Base, error) {
...
func (b *BTSE) GetExchangeHistory(p pair.CurrencyPair, assetType assets.AssetType) ([]exchange.TradeHistory, error) {
...
func (b *BTSE) CancelAllOrders(orderCancellation exchange.OrderCancellation) (exchange.CancelAllOrdersResponse, error) {
	r, err := b.CancelOrders(b.FormatExchangeCurrency(orderCancellation.CurrencyPair,
		assets.AssetTypeSpot).String())
	if err != nil {
